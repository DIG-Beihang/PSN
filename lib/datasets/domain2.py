...
class domain2(imdb):
    def __init__(self, image_set,  devkit_path=None):
        imdb.__init__(self, 'domain2_'+ image_set)
        self._year = '2012'
        self._image_set = image_set
        self._devkit_path = cfg_d.DOMAIN2#self._get_default_path() if devkit_path is None \
            #else devkit_path
        self._data_path = os.path.join(self._devkit_path)
        self._classes = ('__background__',  # always index 0
                'drinkbottle','pressure','lighter','knife','smallelectronicequipmen','powerbank','umbrella','glassbottle','scissor','laptop')
    ...
    def _load_image_set_index(self):
        ...
        image_set_file = os.path.join(self._data_path, 'val.txt')
