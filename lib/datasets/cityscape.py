...
class cityscape(imdb):
    ...
    def _load_pascal_annotation(self, index):
        ...
        """
        filename = os.path.join(self._data_path, 'Annotations_to_foggy', index + '.xml')
    ...
    def _do_python_eval(self, output_dir='output', test=True):
        ...
        for i, cls in enumerate(self._classes):
            ...
            if test:
                ...
                print('AP for {} = {:.4f} Rec = {:.4f}'.format(cls, ap, np.mean(rec)))
