...
class sim10k_bright(imdb):
    def __init__(self, image_set,  devkit_path=None):
        imdb.__init__(self, 'sim10k_bright_'+ image_set)
        self._year = '2012'
        self._image_set = image_set
        self._devkit_path = cfg_d.SIM10K_BRIGHT#self._get_default_path() if devkit_path is None \
            #else devkit_path
