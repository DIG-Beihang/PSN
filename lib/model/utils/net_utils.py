...
def vis_detections(im, class_name, dets, thresh=0.8):
    ...
    for i in range(np.minimum(10, dets.shape[0])):
        ...
        if score > thresh:
            ...
            font_scale = 0.8
            rectangle_bgr = box_color
            text_offset_x = bbox[0]
            text_offset_y = bbox[1] - 10
            (text_width, text_height) = cv2.getTextSize(text, font, fontScale=font_scale, thickness=1)[0]
            box_coords = ((text_offset_x - 1, text_offset_y + 10), (text_offset_x + text_width, text_offset_y - text_height - 3))
            cv2.rectangle(im, box_coords[0], box_coords[1], rectangle_bgr, cv2.FILLED)
            cv2.putText(im, text, (text_offset_x, text_offset_y), font, font_scale, text_color, 2)
